...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.shingo.lib.epic.PrivacyCheckPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin privacy_check, com.shingo.lib.epic.PrivacyCheckPlugin", e);
    }
    try {
      flutterEngine.getPlugins().add(new me.tossy.flutter.unique_ids.UniqueIdsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin unique_ids, me.tossy.flutter.unique_ids.UniqueIdsPlugin", e);
    }
  }
}
